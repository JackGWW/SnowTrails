...
This document outlines planned enhancements to SnowTrails after migrating to @rnmapbox/maps. Each enhancement will be implemented in a separate PR. DO NOT CHECK IN THIS FILE. 
...
## PR #1: Remove Unused trailPattern State - DONE
...
## PR #2: Enhanced Line Styling - DONE
